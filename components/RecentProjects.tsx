        ...
        {projects.map((project) => (
          ...
          >
            <PinContainer title={project.link} href={project.link}>
              ...
              <h1 className="font-bold lg:text-2xl md:text-xl text-base line-clam-1">
                {project.title}
              </h1>
              ...
              <div className="flex items-center justify-between mt-7 mb-3">
                <div className="flex items-center">
                  {project.iconLists.map((icon, index) => (
                    <div
                      key={icon}
                      className="flex items-center border border-white/[0.2] rounded-full bg-black lg:w-10 lg:h-10 w-8 h-8"
